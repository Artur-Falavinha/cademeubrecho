...
export function ConteudosPageContent() {
  return (
    <div className="space-y-8 sm:space-y-10">
      <motion.section
        className="rounded-2xl border border-border/80 bg-white/90 px-5 py-8 shadow-sm sm:px-6 sm:py-10 md:rounded-3xl md:px-12"
      ...
      <section className="grid gap-6 sm:gap-8 md:grid-cols-3">
        {contentChannels.map((channel, index) => (
          ...
          >
            <Card className="!gap-0 !py-0 flex h-full flex-col overflow-hidden border-border/70 bg-white/80 shadow-sm transition-shadow hover:shadow-lg">
              ...
              <div className="mt-auto border-t border-border/60 bg-muted/40 p-6">
                <Button
                  asChild
